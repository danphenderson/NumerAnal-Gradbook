...
* Chapter 2: Computing with matrices and vectors
  ...
  * p. 105-105, Excercise (4)-(6): Consider 'if $A = Q_1R_1 = Q_2_R_2$', suggest re-writting to $A=Q_1R_1=Q_1^*R_1^*$ (or similar) to avoid a notation conflict. Futhermore, (4) is NOT true without the assumption that $Q$ is normalized.
